...
INSERT INTO `booking` VALUES ('T0001','P0001','A0011','SCH0099','S0001',500,10,'confirmed'),('T0002','P0002','A0011','SCH0099','S0002',550,12,'confirmed'),('T0003','P0003','A0011','SCH0099','S0003',600,10,'confirmed'),('T0004','P0004','A0011','SCH0099','S0004',480,12,'confirmed'),('T0005','P0005','A0011','SCH0099','S0005',520,10,'confirmed'),('T0006','P0006','A0011','SCH0099','S0006',540,12,'confirmed'),('T0007','P0007','A0011','SCH0099','S0007',580,10,'confirmed'),('T0008','P0008','A0011','SCH0099','S0008',620,12,'confirmed'),('T0009','P0009','A0011','SCH0099','S0009',660,10,'confirmed'),('T0010','P0010','A0011','SCH0099','S0010',700,10,'confirmed'),('T0011','P0001','A0011','SCH0099','S0001',500,10,'confirmed'),('T0012','P0002','A0011','SCH0100','S0002',550,12,'confirmed'),('T0013','P0003','A0011','SCH0101','S0003',600,10,'confirmed'),('T0014','P0004','A0011','SCH0102','S0004',480,12,'confirmed'),('T0015','P0005','A0011','SCH0103','S0005',520,10,'confirmed'),('T0016','P0006','A0011','SCH0104','S0006',540,12,'confirmed'),('T1060','P0014','A0016','SCH0041','S0033',189,12,'confirmed'),('T1108','P0002','A0010','SCH0057','S0035',839,0,'confirmed'),('T1196','P0021','A0010','SCH0006','S0037',865,12,'confirmed'),('T1203','P0023',NULL,'SCH0066','S0038',114,0,'confirmed'),('T1212','P0021','A0010','SCH0010','S0038',888,12,'confirmed'),('T1236','P0030','A0010','SCH0067','S0039',630,0,'confirmed'),('T1418','P0017','A0010','SCH0023','S0005',572,10,'confirmed'),('T1641','P0002',NULL,'SCH0053','S0051',51,0,'confirmed'),('T1683','P0007','A0010','SCH0001','S0052',926,10,'confirmed'),('T1951','P0024','A0010','SCH0047','S0061',841,12,'confirmed'),('T2045','P0024','A0016','SCH0084','S0001',899,12,'confirmed'),('T2291','P0017','A0016','SCH0102','S0071',776,10,'confirmed'),('T2401','P0005','A0010','SCH0072','S0075',20,0,'confirmed'),('T2457','P0030','A0010','SCH0100','S0076',308,0,'confirmed'),('T2496','P0003','A0010','SCH0083','S0078',963,10,'confirmed'),('T2570','P0002','A0008','SCH0024','S0080',482,0,'confirmed'),('T2725','P0001','A0008','SCH0073','S0085',615,12,'confirmed'),('T2790','P0001','A0008','SCH0072','S0087',996,12,'confirmed'),('T2792','P0026','A0008','SCH0064','S0087',496,12,'confirmed'),('T2807','P0023','A0008','SCH0061','S0009',505,0,'confirmed'),('T2867','P0029','A0010','SCH0095','S0089',276,10,'confirmed'),('T2881','P0010','A0008','SCH0013','S0089',535,0,'confirmed'),('T2928','P0012','A0008','SCH0024','S0091',617,0,'confirmed'),('T3183','P0005',NULL,'SCH0055','S0099',594,0,'confirmed'),('T3211','P0002',NULL,'SCH0013','S0010',762,0,'confirmed'),('T3212','P0011',NULL,'SCH0073','S0100',114,10,'confirmed'),('T3229','P0002',NULL,'SCH0062','S0100',772,0,'confirmed'),('T3268','P0023','A0001','SCH0100','S0101',998,0,'confirmed'),('T3307','P0020',NULL,'SCH0058','S0011',14,12,'confirmed'),('T3325','P0016','A0011','SCH0069','S0103',948,0,'confirmed'),('T3361','P0013',NULL,'SCH0049','S0104',318,0,'confirmed'),('T3407','P0006','A0013','SCH0068','S0106',215,12,'confirmed'),('T3467','P0024','A0013','SCH0098','S0108',423,12,'confirmed'),('T3525','P0016','A0013','SCH0030','S0109',533,0,'confirmed'),('T3526','P0006','A0013','SCH0027','S0109',404,12,'confirmed'),('T3545','P0017','A0013','SCH0011','S0110',857,10,'confirmed'),('T3603','P0008','A0013','SCH0073','S0012',51,0,'confirmed'),('T3676','P0027','A0013','SCH0008','S0114',772,10,'confirmed'),('T3787','P0014','A0013','SCH0053','S0012',570,12,'confirmed'),('T3835','P0003','A0013','SCH0021','S0119',64,10,'confirmed'),('T3875','P0028','A0013','SCH0071','S0120',924,0,'confirmed'),('T4081','P0014','A0013','SCH0105','S0013',981,12,'confirmed'),('T5706','P0018','A0013','SCH0070','S0018',984,10,'confirmed'),('T6619','P0015','A0012','SCH0010','S0021',484,0,'confirmed'),('T7004','P0004',NULL,'SCH0069','S0022',260,12,'confirmed'),('T8820','P0026','A0013','SCH0056','S0028',809,12,'confirmed'),('T8866','P0029','A0013','SCH0023','S0028',683,10,'confirmed'),('T8887','P0030','A0014','SCH0010','S0028',858,0,'confirmed'),('T9070','P0021','A0014','SCH0097','S0029',696,12,'confirmed'),('T9605','P0029','A0011','SCH0061','S0030',897,10,'confirmed');
...
CREATE TABLE `coach` (
  ...
  CONSTRAINT `coach_ibfk_3` FOREIGN KEY (`train_id`) REFERENCES `train` (`train_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `op_days` (
  ...
  CONSTRAINT `op_days_ibfk_2` FOREIGN KEY (`days`) REFERENCES `weekday` (`day`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `weekday` VALUES ('Friday'),('Monday'),('Saturday'),('Sunday'),('Thursday'),('Tuesday'),('Wednesday');
...
-- Dump completed on 2023-11-30  2:09:37
